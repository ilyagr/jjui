...
var builtInActions = map[string]struct{}{
	...
	"revisions.details.page_down":                {},
	"revisions.details.page_up":                  {},
	...
	"revisions.evolog.page_down":                 {},
	"revisions.evolog.page_up":                   {},
...
func BuiltInActions() []string {
	out := make([]string, 0, len(builtInActions))
	for action := range builtInActions {
